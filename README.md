...
[![npm version](https://badge.fury.io/js/flexbox-helper.svg)](https://www.npmjs.com/package/flexbox-helper)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

## Installation

```bash
npm install flexbox-helper
```

## Quick Start

```javascript
const { helper } = require('flexbox-helper');

// Basic usage
const result = helper('your input here');
console.log(result);
```
...
```javascript
const { helper, batch } = require('flexbox-helper');
